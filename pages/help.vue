      ...
      <div class="container m-auto px-4">
        <div class="lg:flex justify-between items-center">
          <div class="lg:w-6/12 md:text-left text-center">
            <div class="md:text-3xl text-xl font-semibold mb-7">
              How can we help?
            </div>
    ...
    <div class="bg-white lg:py-10 py-8">
      <div class="container m-auto px-6 lg:-mt-44">
        <div class="grid lg:grid-cols-2 gap-6">
          ...
          >
            <img
              src="../assets/images/icons/help-icon-1.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">
              ...
              <p class="text-gray-600">
                Welcome to Courseplus! We're so glad you're here. Let's get
                started!
              </p>
              <div class="flex mt-2 space-x-2">
                ...
                <div class="flex-1 leading-5 text-sm space-y-1">
                  ...
                  <span class="font-semibold">Fiona Burke </span>,
                  <span class="font-semibold">Luisa Woodfine</span>
                  <span class="font-semibold text-muted">and</span>
          ...
          >
            <img
              src="../assets/images/icons/help-icon-2.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">
              ...
              <p class="text-gray-500">
                Adjust your profile and preferences to make Courseplus work just
                for you!
              </p>
              <div class="flex mt-2 space-x-2">
                <div class="flex items-center -space-x-2 -mt-1">
          ...
          >
            <img
              src="../assets/images/icons/help-icon-4.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">
              ...
              <p class="text-gray-500">
                Detailed information on how our customer data is securely
                stored.
              </p>
              <div class="flex mt-2 space-x-2">
                <div class="flex items-center -space-x-2 -mt-1">
          ...
          >
            <img
              src="../assets/images/icons/help-icon-3.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">
              ...
              <p class="text-gray-500">
                Some further explanation on when Courseplus can and cannot be
                used.
              </p>
              <div class="flex mt-2 space-x-2">
                <div class="flex items-center -space-x-2 -mt-1">
          ...
          >
            <img
              src="../assets/images/icons/help-icon-5.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">
              ...
              <p class="text-gray-500">
                Assistance on how and when you might use the subscription
                product.
              </p>
              <div class="flex mt-2 space-x-2">
                <div class="flex items-center -space-x-2 -mt-1">
          ...
          >
            <img
              src="../assets/images/icons/help-icon-6.png"
              alt=""
              class="lg:w-24 lg:h-14 w-10 h-10 mb-2 object-cover"
            />
            <div class="space-y-3 lg:ml-4">

    ...
    >
      <div class="container m-auto px-4">
        <div
          ...
          "
        >
          <div class="lg:text-4xl text-2xl font-semibold mb-6">
            How can we help?
          </div>

          <div
            class="bg-white mb-5 relative rounded-md lg:w-1/2 w-full shadow-lg"
            id="search"
            khidden=""
          >
            <ion-icon
              name="search-outline"
              class="absolute h-full hydrated left-3 text-lg md text-gray-600"
              role="img"
              aria-label="search outline"
            ></ion-icon>
            <input
              placeholder="Search"
              class="focus:outline-none h-12 pl-10 rounded-lg w-full"
            />
          </div>

          <p class="text-sm text-center">
            Popular help topics:
            <a class="text-gray-200 hover:underline hover:text-white" href="#"
              >pricing,</a
            >
            <a class="text-gray-200 hover:underline hover:text-white" href="#"
              >upgrade,</a
      ...
      <div class="lg:w-8/12 mx-auto">
        ...
        <ul class="uk-accordion space-y-2" uk-accordion="">
          <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md">
            <a class="uk-accordion-title text-base" href="#">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit?
            </a>
            <div class="uk-accordion-content mt-3" aria-hidden="true" hidden="">
              <p>
                Vivamus imperdiet venenatis est. Phasellus vitae mauris
                ...
                dui sed quam consectetur elementum.
              </p>
            </div>
          </li>
          <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md">
            <a class="uk-accordion-title text-base" href="#">
              Nullam massa sem, mollis luctus at, tincidut?
            </a>
            <div class="uk-accordion-content mt-3" aria-hidden="true" hidden="">
              <p>
                Vivamus imperdiet venenatis est. Phasellus vitae mauris
